using TechStore.Api.Application.Features.Queries.GetEntries;
using TechStore.Api.Application.Features.Queries.GetEntryComments;
using TechStore.Api.Application.Features.Queries.GetEntryDetail;
using TechStore.Api.Application.Features.Queries.GetMainPageEntries;
using TechStore.Api.Application.Features.Queries.GetUserEntries;
