using TechStore.Api.Application.Features.Commands.Entry.CreateFav;
using TechStore.Api.Application.Features.Commands.Entry.DeleteFav;
using TechStore.Api.Application.Features.Commands.EntryComment.CreateFav;
using TechStore.Api.Application.Features.Commands.EntryComment.DeleteFav;
using MediatR;
